...
module.exports = {
	...
	random_string: function(args) {return casual.random_string({min_length:args.min_length, max_length:args.max_length, extras : 
    ...
    randify: function(args) {return casual.randify({format:args.format, extras:args.extra, exclude_digits:args.exclude_digits, 
