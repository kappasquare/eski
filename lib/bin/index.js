...
const sections = [{
    ...
    },
    {
        ...
        optionList: [{
            ...
            {
                name: 'port',
                description: 'Port on which the Eskimo server must be started. Defaults to 3000.'
            }
        ]
    }
]
...
if ('help' in options) {
    ...
    consola.error("Unable to start Eskimo because no route configuration file was provided! \nSee eskimo --help for more information.")
}
else {
        server.start({
            port: options.port,
